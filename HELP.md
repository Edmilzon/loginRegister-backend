...
* The original package name 'com.example.demo-login' is invalid and this project uses 'com.example.demo_login' instead.
...
```
$ docker run --rm -p 8080:8080 demo-login:0.0.1-SNAPSHOT
```
